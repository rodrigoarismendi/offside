...
when not matched then
    insert (league_id, season, team_id, team_name, rank, points, goals_diff,
            group_name, form, played, win, draw, lose, goals_for, goals_against, loaded_at)
    values (s.league_id, s.season, s.team_id, s.team_name, s.rank, s.points, s.goals_diff,
            s.group_name, s.form, s.played, s.win, s.draw, s.lose, s.goals_for, s.goals_against, s.loaded_at);